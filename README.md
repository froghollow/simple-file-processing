...
**Step Function Workflow** -- AWS Step Functions provide orchestration services that enable combining various services into workflows that are managable via Web UI.  This SIMPLE prototype uses a Step Function to Unzip CSVs using Lambda and tranforms them into Parquet format using Glue ETL.  
